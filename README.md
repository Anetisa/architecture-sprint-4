...
Решение: ["Планирование: анализ, идентификация проблем и поиск решений"](/Exc1/Планирование:-анализ,-идентификация-проблем-и-поиск-решений.md)
...
Решение: ["Выбор и настройка мониторинга в системе.md"](/Exc2/Выбор-и-настройка-мониторинга-в-системе.md)
...
Решение:
["Архитектурное решение по трейсингу"](/Exc3/Архитектурное-решение-по-трейсингу.md)
...
Решение: ["Архитектурное решение по логированию"](/Exc4/Архитектурное-решение-по-логированию.md)
...
Решение: ["Архитектурное решение по кешированию"](/Exc5/Архитектурное-решение-по-кешированию.md)